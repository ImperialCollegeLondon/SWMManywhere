...
def flwdir_whitebox(fid: Path, wbt_zip_path: Path | None = None) -> np.array:
...
def graph_to_file(graph: nx.Graph, fid_nodes: Path, fid_edges: Path, crs: str):
    """Write a graph to a GeoJSON or GeoParquet file.
